...
export class LoginComponent {
  ...
  constructor(
    ...
    this.loginForm.valueChanges.subscribe(() => {
      this.loginError = null; // clear the error
    });
  }
  get email() {
    return this.loginForm.controls['email']; // get the email control
  }
  get password() {
    return this.loginForm.controls['password']; // get the password control
  }
  // loginUser() {
